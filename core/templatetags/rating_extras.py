...
_TIER_META = {
    "preliminary": {"label": "Предв.", "badge_class": "badge-ghost"},
    "basic": {"label": "Умеренно", "badge_class": "badge-info badge-outline"},
    "high": {"label": "Надёжно", "badge_class": "badge-success badge-outline"},
}
