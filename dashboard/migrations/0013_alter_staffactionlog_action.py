# dashboard/migrations/0013_alter_staffactionlog_action.py
# Ручная миграция (см. докстринг 0009/0011/0012 — choices не enforced на
# уровне БД). Добавляет partner_created/partner_updated/partner_deleted/
# banner_created/banner_updated/banner_deleted (2026-09-23, раздел
# «Партнёры и баннеры») — см. dashboard/models.py::AuditAction.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0012_alter_staffactionlog_action'),
    ]
