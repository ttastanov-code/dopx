# dashboard/migrations/0017_alter_staffactionlog_action.py
# Ручная миграция (см. докстринг 0009/0011/0012/0013/0015/0016 — то же
# Django-окружение здесь недоступно для makemigrations). Добавляет
# sportmonks_sync_toggled (2026-09-23, рубильник синка с Sportmonks) — см.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dashboard', '0016_alter_staffactionlog_details'),
    ]
